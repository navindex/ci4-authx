...
class PersistenceTokenModel extends BaseModel implements TokenModelInterface
{
	...
	protected $returnType = PersistenceToken::class;
	 ...
	 * @param string $selector Device selector
	 *
	 * @return null|\App\Entities\PersistenceToken Token entity
	 */
	public function getToken(string $selector): ?PersistenceToken
	{
